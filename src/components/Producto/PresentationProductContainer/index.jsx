  ...
  return(
    <article className="text-white grid grid-cols-2 py-20 bg-[#1F2D37] gap-x-4">
      <section className="flex flex-col items-start">
        ...
        <Link to={`/curus/producto/venta`}  className={`styles_button-base px-6 bg-transparent text-purple-500 border border-purple-500 hover:text-white  hover:shadow-md hover:bg-purple-500 transition-all ease-in-out duration-150 `}>
            Ver Producto
        </Link>
      </section>
      <section>
